...
uncertainty_planning_core::SE2SimulatorPtr fast_kinematic_simulator::MakeSE2Simulator(const sdf_tools::TaggedObjectCollisionMapGrid& environment, const sdf_tools::SignedDistanceField& environment_sdf, const simple_simulator_interface::SurfaceNormalGrid& surface_normals_grid, const simple_particle_contact_simulator::SimulatorSolverParameters& solver_config, const double simulation_controller_frequency, const int32_t debug_level)
{
...
uncertainty_planning_core::SE3SimulatorPtr fast_kinematic_simulator::MakeSE3Simulator(const sdf_tools::TaggedObjectCollisionMapGrid& environment, const sdf_tools::SignedDistanceField& environment_sdf, const simple_simulator_interface::SurfaceNormalGrid& surface_normals_grid, const simple_particle_contact_simulator::SimulatorSolverParameters& solver_config, const double simulation_controller_frequency, const int32_t debug_level)
{
...
uncertainty_planning_core::LinkedSimulatorPtr fast_kinematic_simulator::MakeLinkedSimulator(const sdf_tools::TaggedObjectCollisionMapGrid& environment, const sdf_tools::SignedDistanceField& environment_sdf, const simple_simulator_interface::SurfaceNormalGrid& surface_normals_grid, const simple_particle_contact_simulator::SimulatorSolverParameters& solver_config, const double simulation_controller_frequency, const int32_t debug_level)
{
